import { IconButton, LinearProgress, Paper, Typography } from '@material-ui/core'
...
export default function audioSend({stopRecording, mediaBlob, progress, seconds,progressRef, setProgress, setAddVoice}) {
